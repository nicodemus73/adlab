...
<html>
    ...
    <body>
        <%
            ImageWS_Service service = new ImageWS_Service(new URL("WEB-INF/wsdl/localhost_8080/ImageWSApplication/ImageWS.wsdl"));          
        ...
        <table>
            ...
            <%
                List<Object> list = service.getImageWSPort().listImages();
                for (Object o : list) {
                    Image img = (Image) o;
